...
class driverController{
    ...
    async createDriver(req, res) {
        ...
        try {
            const newDriver = await db.query(`INSERT INTO driver (driver_surname, driver_firstname, 
                driver_secondname, driver_email, password, driver_experience) values ($1, $2, $3, $4, $5, $6) 
                RETURNING id_driver`, [surname, firstName, secondName, email, hash, experience])
    ...
    async updateDriver(req, res){
        try{
            ...
            const driver = await db.query(`update driver set driver_surname = '${surname}', driver_firstname = '${firstName}', driver_secondname = '${secondName}'
